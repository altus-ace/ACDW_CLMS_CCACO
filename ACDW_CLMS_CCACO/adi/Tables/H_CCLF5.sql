CREATE TABLE [adi].[H_CCLF5] (
    ...
    [RNDRG_PRVDR_FIPS_ST_CD]  VARCHAR (2)     NULL,
    [CLM_PRVDR_SPCLTY_CD]     VARCHAR (2)     NULL,
    [CLM_FED_TYPE_SRVC_CD]    VARCHAR (1)     NULL,
    [CLM_POS_CD]              VARCHAR (2)     NULL,
    [CLM_LINE_FROM_DT]        VARCHAR (10)    NULL,
    [CLM_LINE_THRU_DT]        VARCHAR (10)    NULL,
    [CLM_LINE_HCPCS_CD]       VARCHAR (5)     NULL,
    [CLM_LINE_CVRD_PD_AMT]    VARCHAR (15)    NULL,
    [CLM_LINE_PRMRY_PYR_CD]   VARCHAR (1)     NULL,
    ...
    [CLM_EFCTV_DT]            VARCHAR (10)    NULL,
    [CLM_IDR_LD_DT]           VARCHAR (10)    NULL,
    ...
    [HCPCS_1_MDFR_CD]         VARCHAR (2)     NULL,
    [HCPCS_2_MDFR_CD]         VARCHAR (2)     NULL,
    [HCPCS_3_MDFR_CD]         VARCHAR (2)     NULL,
    [HCPCS_4_MDFR_CD]         VARCHAR (2)     NULL,
    [HCPCS_5_MDFR_CD]         VARCHAR (2)     NULL,
