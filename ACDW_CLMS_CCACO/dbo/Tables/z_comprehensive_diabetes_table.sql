CREATE TABLE [dbo].[z_comprehensive_diabetes_table] (
    ...
    [MEMBER_HOME_ZIP_C]              VARCHAR (5)   NULL,
    ...
    [MEMBER_MAIL_ZIP_C]              VARCHAR (5)   NULL,
    ...
    [RISK_CATEGORY_C]                VARCHAR (25)  NULL,
    ...
    [ACE_MemberByPCP_URN]            INT           NOT NULL,
    [ACE_Membership_URN]             INT           NULL,
    ...
    [diagnosis]                      VARCHAR (8)   NULL,
    [mailing_list]                   VARCHAR (37)  NULL,
    [both_list]                      VARCHAR (41)  NULL,
    [AWC(Default)]                   INT           NULL,
    [CDC1 HbA1c<8%]                  INT           NULL,
    [PPC Postpartum Care]            INT           NULL,
    [PPC Prenatal Care]              INT           NULL,
    [WC3456(Default)]                INT           NULL,
    [rec1]                           VARCHAR (20)  NULL,
    [recdate1]                       DATE          NULL,
    [rec1code]                       VARCHAR (MAX) NULL,
    [recdate2]                       DATE          NULL,
    [rec2]                           VARCHAR (20)  NULL,
    [rec2code]                       VARCHAR (MAX) NULL,
    [recdate3]                       DATE          NULL,
    [rec3]                           VARCHAR (20)  NULL,
    [rec3code]                       VARCHAR (MAX) NULL,
    [freq1sig]                       VARCHAR (20)  NULL,
    [freq1codesig]                   VARCHAR (MAX) NULL,
    [freq2sig]                       VARCHAR (20)  NULL,
    [freq2codesig]                   VARCHAR (MAX) NULL,
    [freq3sig]                       VARCHAR (20)  NULL,
    [freq3codesig]                   VARCHAR (MAX) NULL,
    [freq4sig]                       VARCHAR (20)  NULL,
    [freq4codesig]                   VARCHAR (MAX) NULL,
    [freq5sig]                       VARCHAR (20)  NULL,
    [freq5codesig]                   VARCHAR (MAX) NULL,
    [freq1]                          VARCHAR (20)  NULL,
    [freq1code]                      VARCHAR (MAX) NULL,
    [freq2]                          VARCHAR (20)  NULL,
    [freq2code]                      VARCHAR (MAX) NULL,
    [freq3]                          VARCHAR (20)  NULL,
    [freq3code]                      VARCHAR (MAX) NULL,
    [freq4]                          VARCHAR (20)  NULL,
    [freq4code]                      VARCHAR (MAX) NULL,
    [freq5]                          VARCHAR (20)  NULL,
    [freq5code]                      VARCHAR (MAX) NULL,
    [testdate1]                      DATE          NULL,
    [test1]                          VARCHAR (250) NULL,
    [testdate2]                      DATE          NULL,
    [test2]                          VARCHAR (250) NULL,
    [testdate3]                      DATE          NULL,
    [test3]                          VARCHAR (250) NULL,
    [testdate4]                      DATE          NULL,
    [test4]                          VARCHAR (250) NULL
);
