...
BEGIN TRAN
	...
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('FOBT','','','',CONCAT('1/1/',@MeasurementYear), CONCAT('12/31/',@MeasurementYear))
	UNION
	SELECT SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('Flexible Sigmoidoscopy','','','',CONCAT('1/1/',@MeasurementYear-4), CONCAT('12/31/',@MeasurementYear))
	UNION
	SELECT SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('Colonoscopy','','','',CONCAT('1/1/',@MeasurementYear-9), CONCAT('12/31/',@MeasurementYear))
	UNION
	SELECT SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('CT Colonography','','','',CONCAT('1/1/',@MeasurementYear-4), CONCAT('12/31/',@MeasurementYear))
	UNION
	SELECT SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate
	FROM [adw].[2020_tvf_Get_ClaimsByValueSet]('FIT-DNA','','','',CONCAT('1/1/',@MeasurementYear-2), CONCAT('12/31/',@MeasurementYear))
