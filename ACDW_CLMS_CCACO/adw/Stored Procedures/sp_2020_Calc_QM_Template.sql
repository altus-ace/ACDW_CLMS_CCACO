...
-- =============================================
CREATE PROCEDURE [adw].[sp_2020_Calc_QM_Template] 
...
BEGIN TRAN
	...
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('Major Depression and Dysthymiae','','','',@PrimSvcDate_Start,@PrimSvcDate_End)
	UNION
	SELECT			SUBSCRIBER_ID, ValueCodeSystem, ValueCode, ValueCodeSvcDate
	FROM			[adw].[2020_tvf_Get_ClaimsByValueSet]('Ambulatory Outpatient Visits','Well-Care','','',@PrimSvcDate_Start,@PrimSvcDate_End)
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_Template] '[ACE-SDV-DB01].[ACDW_CLMS_CCACO].[adw].[QM_ResultByMember_TESTING]',2019,6
***/