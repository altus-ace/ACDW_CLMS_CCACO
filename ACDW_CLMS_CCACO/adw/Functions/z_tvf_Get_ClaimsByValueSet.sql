...
/***
Retrieves list Claims Header Info based on ValueSet 
***/

CREATE  FUNCTION [adw].[z_tvf_Get_ClaimsByValueSet]
...
Usage: 
SELECT *
FROM adw.z_tvf_Get_ClaimsByValueSet ('Mammography','','','','01/01/2019','12/31/2019')
***/