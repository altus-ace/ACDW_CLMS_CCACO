...
GO
CREATE STATISTICS [_dta_stat_1485248346_5_7]
    ON [lst].[LIST_HEDIS_CODE]([VALUE_CODE], [VALUE_CODE_SYSTEM]);


GO
CREATE STATISTICS [_dta_stat_1485248346_13_7_5]
    ON [lst].[LIST_HEDIS_CODE]([ACTIVE], [VALUE_CODE_SYSTEM], [VALUE_CODE]);
